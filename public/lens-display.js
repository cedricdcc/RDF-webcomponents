...
var require_utils = __commonJS({
  "node_modules/readable-stream/lib/internal/streams/utils.js"(exports, module) {
    ...
    function isErrored(stream) {
      var _ref2, _ref22, _ref3, _ref4, _ref5, _stream$kIsErrored, _stream$_readableStat3, _stream$_writableStat3, _stream$_readableStat4, _stream$_writableStat4;
      return !!(stream && ((_ref2 = (_ref22 = (_ref3 = (_ref4 = (_ref5 = (_stream$kIsErrored = stream[kIsErrored]) !== null && _stream$kIsErrored !== void 0 ? _stream$kIsErrored : stream.readableErrored) !== null && _ref5 !== void 0 ? _ref5 : stream.writableErrored) !== null && _ref4 !== void 0 ? _ref4 : (_stream$_readableStat3 = stream._readableState) === null || _stream$_readableStat3 === void 0 ? void 0 : _stream$_readableStat3.errorEmitted) !== null && _ref3 !== void 0 ? _ref3 : (_stream$_writableStat3 = stream._writableState) === null || _stream$_writableStat3 === void 0 ? void 0 : _stream$_writableStat3.errorEmitted) !== null && _ref22 !== void 0 ? _ref22 : (_stream$_readableStat4 = stream._readableState) === null || _stream$_readableStat4 === void 0 ? void 0 : _stream$_readableStat4.errored) !== null && _ref2 !== void 0 ? _ref2 : (_stream$_writableStat4 = stream._writableState) === null || _stream$_writableStat4 === void 0 ? void 0 : _stream$_writableStat4.errored));
    }
    module.exports = {
      isDestroyed,
      kIsDestroyed,
    ...
    function from(Readable2, iterable, opts) {
      ...
      readable._destroy = function(error, cb) {
        PromisePrototypeThen(
          ...
          (e8) => process.nextTick(cb, e8 || error)
        );
      };
...
var require_readable = __commonJS({
  "node_modules/readable-stream/lib/internal/streams/readable.js"(exports, module) {
    ...
    Readable2.wrap = function(src, options) {
      var _ref2, _src$readableObjectMo;
      return new Readable2({
        objectMode: (_ref2 = (_src$readableObjectMo = src.readableObjectMode) !== null && _src$readableObjectMo !== void 0 ? _src$readableObjectMo : src.objectMode) !== null && _ref2 !== void 0 ? _ref2 : true,
        ...options,
      ...
      *readQuads(subject, predicate, object, graph) {
      ...
      contains(other) {
        ...
        for (const graph in g2) {
          ...
          s1 = s1.subjects;
          for (const subject in s22 = g2[graph].subjects) {
...
function getIndex({ subject, predicate, object }, set) {
  const s4 = subject.value || set.has(subject) || (set.add(subject), false);
  const p3 = predicate.value || set.has(predicate) || (set.add(predicate), false);
  const o7 = object.value || set.has(object) || (set.add(object), false);
  return !s4 && p3 ? { content: "predicates", value: [predicate, object, subject] } : o7 ? { content: "objects", value: [object, subject, predicate] } : { content: "subjects", value: [subject, predicate, object] };
}
    ...
    N3Reasoner = class {
      ...
      _reasonGraphNaive(rules, content) {
        ...
        while ((r6 = newRules.pop()) !== void 0) {
          const [subject, predicate, object, rule] = r6;
...
var CONFIG_KEYS = /* @__PURE__ */ new Set(["theme", "class"]);
async function parseLensDisplayConfigRdf(content, format, source) {
  ...
  const configSubjects = new Set(
    parsedQuads.filter((quad2) => quad2.predicate.value === RDF_TYPE && quad2.object.value === LENS_DISPLAY_CONFIG_TYPE).map((quad2) => quad2.subject.value)
  );
  for (const quad2 of parsedQuads) {
...
function _arrayLikeToArray(r6, a3) {
  ...
  for (var e8 = 0, n5 = Array(a3); e8 < a3; e8++) n5[e8] = r6[e8];
  return n5;
}
...
function _iterableToArrayLimit(r6, l3) {
  ...
  if (null != t5) {
    var e8, n5, i6, u3, a3 = [], f3 = true, o7 = false;
    try {
      if (i6 = (t5 = t5.call(r6)).next, 0 === l3) ;
      else for (; !(f3 = (e8 = i6.call(t5)).done) && (a3.push(e8.value), a3.length !== l3); f3 = true) ;
    } catch (r7) {
      o7 = true, n5 = r7;
    } finally {
      try {
...
function _slicedToArray(r6, e8) {
  return _arrayWithHoles(r6) || _iterableToArrayLimit(r6, e8) || _unsupportedIterableToArray(r6, e8) || _nonIterableRest();
}
...
var TemplateEngine = class {
  ...
  renderItem(template, data) {
    ...
    result = result.replace(/\{\{\{([^}]+)\}\}\}/g, (_2, path) => {
      ...
      return browser_default.sanitize(String(value ?? ""));
    });
    result = result.replace(/\{\{([^#/][^}]*)\}\}/g, (_2, path) => {
